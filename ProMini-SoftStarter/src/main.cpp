...
#define ledred 5          //LED shows whether system is ready to softstart
#define ledgreen 6        //LED  shows whether softstart occured
#define ledblue 9
...
// push perlu dimodifikasi, bisa langsung hidup atau komunikasi dengan serial